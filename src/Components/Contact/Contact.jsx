...
const Contact = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (!contactdetails.email || !contactdetails.msg) {
      return toast.error('All fields are Required')

    } else {
      console.log(contactdetails)

      addDoc(collection(db, "contact details"), {
        email: contactdetails.email,
        msg: contactdetails.msg

      }).then((res) =>
        toast.success("succes submited details")
  ...
  return (
    <><section className="text-gray-600 body-font -z-20 relative">
      ...
      <div className="container px-5 py-24 mx-auto -z-2 flex">
        <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
          ...
          <button onClick={handleSubmit} className="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
